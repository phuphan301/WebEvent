  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          Name: <a href="#" class="d-block">${sessionScope.currentUser.username}</a>
        </div>
      </div>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<c:url value='videos?action=view'/>" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>OverView</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<c:url value='videos?action=add'/>" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Edit Video</p>
                </a>
              </li>
  ...
  <div class="content-wrapper">
    ...
    <!-- /.card -->
            ...
            <div style="width: 100%; height: 300px; border: 1px solid black">
            	<img alt="" src="${video != null? video.poster : '' }" height="100%" width="100%" style="object-fit: cover;" id="imgPreview">
            </div>
            
		    <label for="exampleInputEmail1" class="form-label">Title</label>
		    <input id="title"  type="text" class="form-control" value="${video != null? video.title : '' }" aria-describedby="emailHelp" style="width: 50%">
		   
		  </div>
		  <div class="mb-3">
		    <label for="exampleInputPassword1" class="form-label">Href</label>
		    <input id="newHref" type="text" class="form-control" value="${video != null? video.href : '' }">
		  </div>
		  <div class="mb-3">
		    <label for="exampleInputPassword1" class="form-label">Description</label>
		    <textarea id="description" class="form-control" rows="5" id="comment" name="text">${video != null? video.description : '' }</textarea>
		  </div>
		  <div class="mb-3">
		    <label for="exampleInputPassword1" class="form-label">Poster</label>
		    <input id="poster" type="text" class="form-control" value="${video != null? video.poster : '' }">
		    <input id="isEdit" type="hidden" class="form-control" value="${isEdit}">
		  </div>
		  <button id="submitBtn" type="button" class="btn btn-primary mb-5">Submit</button>
		  <button id="resetBtn" type="button" class="btn btn-primary mb-5">Reset</button>
		   <p id="message" class="form-label"></p>
            <!-- /.card -->
    </section>
    <!-- /.content -->
  </div>
...
$('#submitBtn').click(function(){
	...
	if(isEdit == 'true'){
		url='/WebEvent/videos?action=edit&href='+ hrefOrigin;
	}else{
		url='/WebEvent/videos?action=add';
	}
	var formData = {
	...
	$.ajax({
		...
		window.location.href="http://localhost:8080/WebEvent/videos?action=view";
	}).fail(function(error){
