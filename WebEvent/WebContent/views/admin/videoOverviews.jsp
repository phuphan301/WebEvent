        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<c:url value='videos?action=view'/>" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>OverView</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<c:url value='videos?action=add'/>" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Add Video</p>
                </a>
              </li>
                  ...
                  <tbody>
	                  <%----%> <c:forEach items="${videos}" var="item">
	                  	<tr>
	                  		...
	                  		<td>
	                  			 <img src="${item.poster}" width="150px" height="150px" > </td>
	                  		<td>
	                  			<a href="<c:url value='/videos?action=edit&href=${item.href}'/>" type="button" class="btn btn-outline-primary">Edit</a>
	                  			<button type="button" onclick = "deleteVideo('${item.href}')" class="btn btn-outline-danger mt-3" >Delete</button>
	                  		</td> 
	                  	</tr>
	                  </c:forEach> 
                  </tbody>
...
function deleteVideo(href){
	$.ajax({
		url : 'WebEvent/admin/video?action=delete&href='+href
	}).then(function(){
...
function deleteVideo(href) {
	$.ajax({
		url:'/WebEvent/videos?action=delete&href=' + href
	}).then(function(data) {
		window.location.href = "/WebEvent/videos?action=view";
