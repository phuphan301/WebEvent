        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="videos?action=view" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>OverView</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="videos?action=add" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Edit Video</p>
                </a>
              </li>
    ...
    <!-- /.card -->
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Favorite like static</h3>
              </div>
    	              <div class="card-body">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Favorite like info</h3>
              </div>
    	       <div class="card-body">
    	       	<div class="form-group">
                    <label>List Video</label>
                    <select id="selectVideoTitle" class="form-control">
                    <%----%> <option selected disabled>Video Title</option>
                    	<c:forEach items="${videos}" var="item">
...
<script>
  ...
  $('#selectVideoTitle').change(function(){
